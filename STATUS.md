...
| Contracts | Scheduled supply, payment, penalties, fulfillment, attribution, breach, and termination. Partially paid penalties accumulate on the contract as recoverable breach debt regardless of whether the missed delivery terminates it, and an inactive party's termination collects whatever penalty cash it still holds before recording the remainder. |
...
| Property | Ownership, value drift with district conditions, tenancy, occupancy, rent scaled by the district rent index for vacancy income and sitting tenants alike, purchase, collateral, liquidation, lien settlement, and distressed civic guarantees. Closed or insolvent occupants are evicted at the weekly settlement so their units return to vacancy income instead of blocking it; a recovered firm re-occupying rented premises restores its tenancy. |
...
| AI | Deterministic objectives for property, supply, office, debt, legitimacy, liquidity, and rival pressure; monthly household upkeep with standing penalties for shortfalls; private-credit participation through the canonical loan machinery, deploying borrowed principal into the shortfall that motivated it; recapitalization only for lifetime-profitable businesses; property purchases that preserve the recovery reserve; grounded legal filing; and institution selection. |
| Crises | Grain, banking, fire, epidemic, guild, external-authority, and trade crises with detection, escalation, response, recovery, effects, and resolution. Trade disruptions track their route condition: organized responses heal the routes, a watch directive counts as a response, and healed routes de-escalate the crisis. Guild revolts scale with chartered-guild disrepute; responses durably shift every guild's legitimacy, feeding back into revolt pressure and office rewards. |
