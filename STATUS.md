...
| Crises | Grain, banking, fire, epidemic, guild, external-authority, and trade crises with detection, escalation, response, recovery, effects, and resolution. Trade disruptions track their route condition instead of escalating on their own: organized responses heal the routes, a standing watch directive counts as an institutional response, and healed routes de-escalate an unaddressed crisis. |
