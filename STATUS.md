...
| Crises | Grain, banking, fire, epidemic, guild, external-authority, and trade crises with detection, escalation, response, recovery, effects, and resolution. Trade disruptions track their route condition: organized responses heal the routes, a watch directive counts as a response, and healed routes de-escalate the crisis. Guild revolts scale with chartered-guild disrepute; responses durably shift guild legitimacy. Crisis phantom demand affects prices only, never wages. |
