...
|---|---|
| World | One detailed city with six districts, regional routes, seasonal pressure, and external disruption. Route health scales both household regional earning power and input-less import-trade output, so disrupted trade tightens household budgets and staple supply directly. Households pay modest monthly living costs scaled by district desirability, so cash-rich demographics face realistic budget pressure and shortfalls erode food satisfaction. |
