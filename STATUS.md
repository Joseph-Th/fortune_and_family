...
| AI houses | Deterministic objectives for property, supply, office, debt, legitimacy, liquidity, and rival pressure; monthly upkeep with great-house wealth stewardship penalizing hoards; private-credit participation funding sound firms first, with speculative credit reserved for liquidity-strained houses or structurally losing firms. Rival supply contracts commit near real weekly input need at penalties scaled to scheduled value. |
