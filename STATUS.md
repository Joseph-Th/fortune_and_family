...
| Businesses | Ownership, management, policy, wages, cash, inventory, production, quality, condition, distress, insolvency, closure, recovery, acquisition, recapitalization, protected owner distributions. Recovery requires modestly deeper cash than onset (4 vs 3 days of operating cover); distressed workshops retain 75% efficiency rather than 60%; quality mean-reverts; operating/maintenance costs credit the market clearing pool. |
