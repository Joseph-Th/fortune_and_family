...
|---|---|
| World | One detailed city with six districts, regional routes, seasonal pressure, and external disruption. Route health scales household earning power and import-trade output via capacity-weighted disruption, so shocks tighten budgets and supply coherently. Living costs scale with district and class at 28/52/78 copper per member monthly (Laboring/Artisan/Merchant) times rent index, so cash-rich groups face material pressure and shortfalls erode satisfaction. |
...
| Business transfer | Failing trades change hands at a discount to book value; a going concern quotes at a 140% controlling premium. Book value inventories are valued at registry base price (not volatile market price) so shortage spikes do not inflate acquisition premiums. Portfolio growth converts wealth into capacity and administrative load at a real cost while the seller ends the exchange richer. Tool-allocation priority rotates daily to avoid systematic starvation of high-ID workshops. |
