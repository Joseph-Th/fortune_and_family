...
pub(crate) fn measure_label(measure: GameplayMeasure) -> &'static str {
    match measure {
        ...
        GameplayMeasure::WrittenOffLoans => "written-off-loans",
        GameplayMeasure::PlayerWrittenOffLending => "written-off-lending",
        GameplayMeasure::PlayerWrittenOffBorrowing => "written-off-borrowing",
